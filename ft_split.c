...
/*   Updated: 2022/11/04 17:37:05 by hez-zahi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_pass(const char *s, char c, int i)
{
	while (s[i] == c)
		i++;
	return (i);
...
int	ft_deff(const char *s, char c, int i)
{
	int	taille;
...
char	**ft_split_aid(int k, char **p, char c, const char *s)
{
	int	t;
	int	i;
	int	j;
